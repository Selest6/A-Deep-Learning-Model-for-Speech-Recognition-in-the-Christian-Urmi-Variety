...
def main() -> None:
    logging.basicConfig(level=logging.INFO)
    p = build_parser()
    p.set_defaults(output_dir='./experiment_2_speed_perturbation', experiment_name='experiment_2_speed_perturbation', train_augment_mode='speed', mask_time_prob=0.0, mask_feature_prob=0.0, speed_factors='0.9,1.1', speed_prob=0.5, add_adapter=True)
