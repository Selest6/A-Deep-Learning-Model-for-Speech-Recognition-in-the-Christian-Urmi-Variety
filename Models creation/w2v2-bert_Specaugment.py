...
def main() -> None:
    logging.basicConfig(level=logging.INFO)
    p = build_parser()
    p.set_defaults(output_dir='./w2v-bert_Specaugment', experiment_name='w2v-bert_Specaugment', train_augment_mode='none', mask_time_prob=0.05, mask_feature_prob=0.02, add_adapter=True, copy_best_checkpoint_to='shared_best_checkpoints')
